...
;;;
;;; Message Implementation of package cljctools.ipfs.proto.dht
;;;----------------------------------------------------------------------------------
(ns cljctools.ipfs.proto.dht
...
(defrecord Record-record [key value timeReceived]
  ...
  pb/TypeReflection
  (gettype [this]
    "cljctools.ipfs.proto.dht.Record"))

(s/def :cljctools.ipfs.proto.dht.Record/key bytes?)
(s/def :cljctools.ipfs.proto.dht.Record/value bytes?)
(s/def :cljctools.ipfs.proto.dht.Record/timeReceived string?)
(s/def ::Record-spec (s/keys :opt-un [:cljctools.ipfs.proto.dht.Record/key :cljctools.ipfs.proto.dht.Record/value :cljctools.ipfs.proto.dht.Record/timeReceived ]))
...
(def ^:protojure.protobuf.any/record Record-meta {:type "cljctools.ipfs.proto.dht.Record" :decoder pb->Record})
...
(defrecord Message-record [type clusterLevelRaw key record closerPeers providerPeers]
  ...
  pb/TypeReflection
  (gettype [this]
    "cljctools.ipfs.proto.dht.Message"))

(s/def :cljctools.ipfs.proto.dht.Message/type (s/or :keyword keyword? :int int?))
(s/def :cljctools.ipfs.proto.dht.Message/clusterLevelRaw int?)
(s/def :cljctools.ipfs.proto.dht.Message/key bytes?)
(s/def :cljctools.ipfs.proto.dht.Message/record bytes?)


(s/def ::Message-spec (s/keys :opt-un [:cljctools.ipfs.proto.dht.Message/type :cljctools.ipfs.proto.dht.Message/clusterLevelRaw :cljctools.ipfs.proto.dht.Message/key :cljctools.ipfs.proto.dht.Message/record ]))
...
(def ^:protojure.protobuf.any/record Message-meta {:type "cljctools.ipfs.proto.dht.Message" :decoder pb->Message})
...
(defrecord Message-Peer-record [id addrs connection]
  ...
  pb/TypeReflection
  (gettype [this]
    "cljctools.ipfs.proto.dht.Message-Peer"))

(s/def :cljctools.ipfs.proto.dht.Message-Peer/id bytes?)
(s/def :cljctools.ipfs.proto.dht.Message-Peer/addrs (s/every bytes?))
(s/def :cljctools.ipfs.proto.dht.Message-Peer/connection (s/or :keyword keyword? :int int?))
(s/def ::Message-Peer-spec (s/keys :opt-un [:cljctools.ipfs.proto.dht.Message-Peer/id :cljctools.ipfs.proto.dht.Message-Peer/addrs :cljctools.ipfs.proto.dht.Message-Peer/connection ]))
...
(def ^:protojure.protobuf.any/record Message-Peer-meta {:type "cljctools.ipfs.proto.dht.Message-Peer" :decoder pb->Message-Peer})
