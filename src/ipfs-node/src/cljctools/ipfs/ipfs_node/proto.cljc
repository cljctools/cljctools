...
;;;
;;; Message Implementation of package cljctools.ipfs.ipfs-node.proto
;;;----------------------------------------------------------------------------------
(ns cljctools.ipfs.ipfs-node.proto
...
(defrecord Record-record [key value timeReceived]
  ...
  pb/TypeReflection
  (gettype [this]
    "cljctools.ipfs.ipfs-node.proto.Record"))

(s/def :cljctools.ipfs.ipfs-node.proto.Record/key bytes?)
(s/def :cljctools.ipfs.ipfs-node.proto.Record/value bytes?)
(s/def :cljctools.ipfs.ipfs-node.proto.Record/timeReceived string?)
(s/def ::Record-spec (s/keys :opt-un [:cljctools.ipfs.ipfs-node.proto.Record/key :cljctools.ipfs.ipfs-node.proto.Record/value :cljctools.ipfs.ipfs-node.proto.Record/timeReceived ]))
...
(def ^:protojure.protobuf.any/record Record-meta {:type "cljctools.ipfs.ipfs-node.proto.Record" :decoder pb->Record})
...
(defrecord Message-record [type clusterLevelRaw key record closerPeers providerPeers]
  ...
  pb/TypeReflection
  (gettype [this]
    "cljctools.ipfs.ipfs-node.proto.Message"))

(s/def :cljctools.ipfs.ipfs-node.proto.Message/type (s/or :keyword keyword? :int int?))
(s/def :cljctools.ipfs.ipfs-node.proto.Message/clusterLevelRaw int?)
(s/def :cljctools.ipfs.ipfs-node.proto.Message/key bytes?)
(s/def :cljctools.ipfs.ipfs-node.proto.Message/record bytes?)


(s/def ::Message-spec (s/keys :opt-un [:cljctools.ipfs.ipfs-node.proto.Message/type :cljctools.ipfs.ipfs-node.proto.Message/clusterLevelRaw :cljctools.ipfs.ipfs-node.proto.Message/key :cljctools.ipfs.ipfs-node.proto.Message/record ]))
...
(def ^:protojure.protobuf.any/record Message-meta {:type "cljctools.ipfs.ipfs-node.proto.Message" :decoder pb->Message})
...
(defrecord Message-Peer-record [id addrs connection]
  ...
  pb/TypeReflection
  (gettype [this]
    "cljctools.ipfs.ipfs-node.proto.Message-Peer"))

(s/def :cljctools.ipfs.ipfs-node.proto.Message-Peer/id bytes?)
(s/def :cljctools.ipfs.ipfs-node.proto.Message-Peer/addrs (s/every bytes?))
(s/def :cljctools.ipfs.ipfs-node.proto.Message-Peer/connection (s/or :keyword keyword? :int int?))
(s/def ::Message-Peer-spec (s/keys :opt-un [:cljctools.ipfs.ipfs-node.proto.Message-Peer/id :cljctools.ipfs.ipfs-node.proto.Message-Peer/addrs :cljctools.ipfs.ipfs-node.proto.Message-Peer/connection ]))
...
(def ^:protojure.protobuf.any/record Message-Peer-meta {:type "cljctools.ipfs.ipfs-node.proto.Message-Peer" :decoder pb->Message-Peer})
